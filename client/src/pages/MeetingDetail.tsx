            ...
            <CardContent className="space-y-6">
              {minutes ? (
                <>
                  ...
                  {minutes.keyPoints && (
                    <div>
                      <h3 className="font-semibold mb-3">主要な議論ポイント</h3>
                      <ul className="space-y-2">
                        {parseJsonSafe(minutes.keyPoints).map((point, index) => (
                  ...
                  {minutes.decisions && (
                    <>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {parseJsonSafe(minutes.decisions).map((decision, index) => (
                            <li key={index} className="flex items-start gap-2">
                  ...
                  {/* Interview specific */}
                  {meeting.meetingType === 'interview' && minutes.candidateName && (
                    <>
                      <Separator />
                      <div className="space-y-4">
                        <h3 className="font-semibold">面接評価</h3>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <span className="text-sm text-muted-foreground">候補者名</span>
                            <p className="font-medium">{minutes.candidateName}</p>
                          </div>
                          {minutes.recommendation && (
                            <div>
                              <span className="text-sm text-muted-foreground">推薦</span>
                              <p className="font-medium">{minutes.recommendation}</p>
                            </div>
                          )}
                        </div>
                        {minutes.evaluationPoints && (
                          <div>
                            <span className="text-sm text-muted-foreground">評価ポイント</span>
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>議事録がまだ生成されていません</p>
                  <p className="text-sm mt-1">処理が完了するまでお待ちください</p>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent>
              {transcript ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p>文字起こしがまだありません</p>
                  <p className="text-sm mt-1">Zoomから文字起こしデータを取得中です</p>
                </div>
              )}
            </CardContent>
          </Card>
